...
class ChallengeDescriptionStartedFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val root = inflater.inflate(
            R.layout.fragment_started_challenge_description,
            container, false)

        val textViewChallengeName =
            root.findViewById<TextView>(R.id.text_view_challenge_started_name)
        val textViewChallengeDescription =
            root.findViewById<TextView>(R.id.text_view_challenge_started_description)
        val imageViewChallenge =
            root.findViewById<ImageView>(R.id.image_view_challenge_started)
